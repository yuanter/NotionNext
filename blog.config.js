...
const BLOG = {
  AUTHOR: '院长', // 作者
  BIO: '用尽三生烟火，换你一世迷离', // 作者简介
  LINK: 'https://vercel.yuanter.top', // 网站地址
  ...
  CONTACT_EMAIL: '1369359503@qq.com', // 邮箱
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: '', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/yuanter', // 你的github个人主页
  CONTACT_TELEGRAM: 'https://t.me/yuanter_res', // 你的telegram 地址 例如 https://t.me/tangly_1024
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Yuanter\'s BLOG', // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
